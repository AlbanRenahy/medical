...
/**
 * Servlet implementation class InfirmiereTest
 */
@WebServlet("/")
public class InfirmiereTest extends HttpServlet {
		...
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 private void listInfirmiere(HttpServletRequest request, HttpServletResponse response)
				    ...
				    throws ServletException, IOException {
				        RequestDispatcher dispatcher = request.getRequestDispatcher("WEB-INF/form_infirmiere.jsp");
				        dispatcher.forward(request, response);
				    }
				    ...
				    throws SQLException, IOException {
				    	int id = Integer.parseInt(request.getParameter("id"));
				    	int adresse_id = Integer.parseInt(request.getParameter("adresse_id"));
				        ...
				        InfirmiereEntitySimple newInfirmiere = new InfirmiereEntitySimple(id,adresse_id,prenom,nom,numeroProfessionnel,telPro,telPerso);
				    ...
				    throws SQLException, IOException {
				        ...
				        InfirmiereEntitySimple newInfirmiere = new InfirmiereEntitySimple(id,adresse_id, nom, prenom, numeroProfessionnel,telPro,telPerso);
